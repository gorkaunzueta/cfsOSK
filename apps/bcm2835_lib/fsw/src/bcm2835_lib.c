...
int32 BCM2835_LIB_Init(void)
{
    ...
    if(OS_MutSemCreate(&(i2c_mutexvar), "i2c_send_mutex", 0) != OS_SUCCESS){
        OS_printf("BCM2835 Lib Mutex Sem not created.\n");
        return CFE_STATUS_NOT_IMPLEMENTED;
    }
    
    OS_printf("BCM2835 Lib Initialized.\n");
